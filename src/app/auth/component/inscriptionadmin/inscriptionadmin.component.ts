...
@Component({
  selector: 'app-inscriptionadmin',
  imports: [CommonModule, ReactiveFormsModule, ReactiveFormsModule],
  templateUrl: './inscriptionadmin.component.html',
  styleUrl: './inscriptionadmin.component.css'
})
export class InscriptionAdminComponent {
  ...
  onSubmit(): void {
    ...
    if (this.inscriptionForm.valid) {
      ...
      this.authService.createUserAdmin(this.inscriptionForm.value).subscribe({
        next: (response) => {
          Swal.fire({
            title: "Succès!",
